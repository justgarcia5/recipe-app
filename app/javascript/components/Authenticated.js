        ...
        <div>
          <Switch>
            ...
            <Route
              ...
              exact
              render={props => (
                <Favorites currentUser={currentUser} {...props} />
              )}
            />
            <Route
              path="/members/blogs"
              exact
              render={props => <Blog currentUser={currentUser} {...props} />}
            />
            <Route
              path="/members/favorites/detail/:id"
              exact
              render={props => (
                <FavoritesDetailPage currentUser={currentUser} {...props} />
              )}
            />
            <Route
